# variables
from db_credentials import data_warehouse_db_config, sqlserver_db_config, mysql_db_config, fbd_db_config
...
def main():
  ...
  target_cnx = pyodbc.connect(**data_warehouse_db_config)
